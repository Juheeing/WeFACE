...
public class NoseCameraActivity2 extends AppCompatActivity {

    Button btn_cam, btn_gallery, btn_close;
    String path;
    File file_2, file2;
    Bitmap bitmap2, rotatedBitmap2;
    public static Context context_nose_camera2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nose_camera2);

        if (ContextCompat.checkSelfPermission(NoseCameraActivity2.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(NoseCameraActivity2.this, new String[]{
                    Manifest.permission.CAMERA
            }, REQUEST_CAMERA_CODE);
        }

        context_nose_camera2 = this;
        ...
        btn_cam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(takePictureIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    if(photoFile != null) {
                        Uri photoURI = FileProvider.getUriForFile(NoseCameraActivity2.this, getPackageName() + ".fileprovider", photoFile);
        ...
        if (requestCode == 2) {
            if (resultCode == RESULT_OK) {
                ...
                try{
                    ...
                    ((NoseImageActivity1) NoseImageActivity1.context_nose).iv_image1.setImageBitmap(bitmap2);
                    ...
                    if (bitmap2 != null) {
                        ...
                        Intent intent = new Intent(NoseCameraActivity2.this, NoseImageActivity3.class);
