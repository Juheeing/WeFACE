...
public class EyeCameraActivity2 extends AppCompatActivity {

    Button btn_cam, btn_gallery, btn_close;
    String path;
    File file_2, file2;
    Bitmap bitmap2, rotatedBitmap2;
    public static Context context_camera2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eye_camera2);

        if (ContextCompat.checkSelfPermission(EyeCameraActivity2.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(EyeCameraActivity2.this, new String[]{
                    Manifest.permission.CAMERA
            }, REQUEST_CAMERA_CODE);
        }

        context_camera2 = this;
        ...
        btn_cam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(takePictureIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    if(photoFile != null) {
                        Uri photoURI = FileProvider.getUriForFile(EyeCameraActivity2.this, getPackageName() + ".fileprovider", photoFile);
        ...
        if (requestCode == 2) {
            if (resultCode == RESULT_OK) {
                ...
                try{
                    ...
                    ((EyeImageActivity1) EyeImageActivity1.context_eye).iv_image1.setImageBitmap(bitmap2);
                    ...
                    if (bitmap2 != null) {
                        ...
                        Intent intent = new Intent(EyeCameraActivity2.this, EyeImageActivity3.class);
