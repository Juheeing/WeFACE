...
public class MouthCameraActivity1 extends AppCompatActivity {

    Button btn_cam, btn_gallery, btn_close;
    String path;
    File file_1, file1;
    Bitmap bitmap1, rotatedBitmap1;
    public static Context context_mouth_camera1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mouth_camera1);


        if (ContextCompat.checkSelfPermission(MouthCameraActivity1.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(MouthCameraActivity1.this, new String[]{
                    Manifest.permission.CAMERA
            }, REQUEST_CAMERA_CODE);
        }

        context_mouth_camera1 = this;
        ...
        btn_cam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(takePictureIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    if(photoFile != null) {
                        Uri photoURI = FileProvider.getUriForFile(MouthCameraActivity1.this, getPackageName() + ".fileprovider", photoFile);
        ...
        if (requestCode == 1) {
            if (resultCode == RESULT_OK) {
                ...
                try{
                    ...
                    ((EyeImageActivity1) EyeImageActivity1.context_eye).iv_image1.setImageBitmap(bitmap1);
                    ...
                    if (bitmap1 != null) {
                        ...
                        Intent intent = new Intent(MouthCameraActivity1.this, MouthImageActivity2.class);
