...
public class EyeCameraActivity1 extends AppCompatActivity {

    Button btn_cam, btn_gallery, btn_close;
    String path;
    File file_1, file1;
    Bitmap bitmap1, rotatedBitmap1;
    public static Context context_camera1;
        ...
        btn_cam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(takePictureIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    if(photoFile != null) {
                        Uri photoURI = FileProvider.getUriForFile(EyeCameraActivity1.this, getPackageName() + ".fileprovider", photoFile);
            ...
            if (resultCode == RESULT_OK) {
                ...
                try{
                    ...
                    if (bitmap1 != null) {
                        ...
                        Intent intent = new Intent(EyeCameraActivity1.this, EyeImageActivity2.class);
