...
public class Loading_Brow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loading_brow);
        ...
        iv_image.setImageBitmap(((BrowCameraActivity1) BrowCameraActivity1.context_brow_camera1).rotatedBitmap1);
        ...
        new Loading_Brow.RestAPITask("http://52.79.174.94:8000/change/check/").execute();
    }
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            while(true) {
                ...
                if (result.equals("{\"text\":\"1\"}")) {
                    Intent intent = new Intent(Loading_Brow.this, ResultActivity.class);
