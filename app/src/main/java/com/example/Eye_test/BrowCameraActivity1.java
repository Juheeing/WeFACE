...
public class BrowCameraActivity1 extends AppCompatActivity {

    Button btn_cam, btn_gallery, btn_close;
    String path;
    File file_1, file1;
    Bitmap bitmap1, rotatedBitmap1;
    public static Context context_brow_camera1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brow_camera1);

        if (ContextCompat.checkSelfPermission(BrowCameraActivity1.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(BrowCameraActivity1.this, new String[]{
                    Manifest.permission.CAMERA
            }, REQUEST_CAMERA_CODE);
        }

        context_brow_camera1 = this;
        ...
        btn_cam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(takePictureIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    if(photoFile != null) {
                        Uri photoURI = FileProvider.getUriForFile(BrowCameraActivity1.this, getPackageName() + ".fileprovider", photoFile);
        ...
        if (requestCode == 1) {
            if (resultCode == RESULT_OK) {
                ...
                try{
                    ...
                    ((BrowImageActivity1) BrowImageActivity1.context_brow).iv_image1.setImageBitmap(bitmap1);
                    ...
                    if (bitmap1 != null) {
                        ...
                        Intent intent = new Intent(BrowCameraActivity1.this, BrowImageActivity2.class);
