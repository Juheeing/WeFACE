...
public class Loading_Nose extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loading_nose);
        ...
        iv_image.setImageBitmap(((NoseCameraActivity1) NoseCameraActivity1.context_nose_camera1).rotatedBitmap1);
        ...
        protected Object doInBackground(Object[] objects) {
            ...
            while(true) {
                ...
                if (result.equals("{\"text\":\"1\"}")) {
                    Intent intent = new Intent(Loading_Nose.this, NoseResultActivity.class);
